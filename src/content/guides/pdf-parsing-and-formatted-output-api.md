---
title: PDF Parsing and Formatted Output API Integration Guide
description: >-
  Learn how to integrate the PDF Parsing and Formatted Output API with
...
apiName: PDF Parsing and Formatted Output
apiMethod: POST
apiEndpoint: /v1/imagerecognition/pdf2format
detailUrl: 'https://gugudata.io/details/pdf2format'
demoUrl: 'https://api.gugudata.io/v1/imagerecognition/pdf2format/demo'
keywords:
  - PDF Parsing and Formatted Output API
  - GuGuData PDF Parsing and Formatted Output
  - pdf2format API
...
# PDF Parsing and Formatted Output API Integration Guide
...
> Start here: [Try the live demo](https://api.gugudata.io/v1/imagerecognition/pdf2format/demo) or [view the current API details](https://gugudata.io/details/pdf2format).
...
```bash
curl -X POST "https://api.gugudata.io/v1/imagerecognition/pdf2format?appkey=YOUR_APPKEY" \
  -F "type=markdown" \
